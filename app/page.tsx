...
const days: Day[] = [
  ...
  },
  {
    ...
    city: "Kyoto",
    japanese: "京都",
    title: "Kiyomizu-dera, Chishakuin & a kimono afternoon",
    summary: "Wake up early for Higashiyama's temples and lanes, drink from Otowa Waterfall, dress in a kimono, and finish with a geisha tea ceremony.",
    events: [
      ...
      {
        time: "10:45",
        title: "Chishakuin Temple",
        note: "See the peaceful garden and celebrated painted screens; the special viewing area opens at 9 AM",
        url: "https://www.google.com/maps/search/?api=1&query=Chishakuin+Temple%2C+Kyoto%2C+Japan",
        linkLabel: "OPEN IN MAPS",
      },
      { time: "12:15", title: "Lunch in Higashiyama", note: "Choose an easy nearby stop and leave enough time for the kimono fitting" },
      {
        time: "13:30",
      ...
      { time: "14:45", title: "Higashiyama stroll in kimono", note: "Take photos along the traditional streets, then allow plenty of time to reach the ceremony" },
  ...
  },
  {
    ...
    events: [
      ...
      { time: "08:15", title: "Train from Kyoto to Nara", note: "Take Kintetsu from Kyoto Station to Kintetsu-Nara · allow about 45–55 minutes" },
      {
        ...
        note: "Use a large coin locker; if lockers are full, ask station staff for the nearest staffed luggage option",
        url: "https://www.kintetsu.co.jp/foreign/english/coinlocker/",
        linkLabel: "LOCKER INFORMATION",
      },
      {
        time: "09:30",
        title: "Explore Nara Park & meet the deer",
        note: "Walk toward the temple through the park; buy official deer crackers and keep maps or loose paper tucked away",
        url: "https://www.google.com/maps/search/?api=1&query=Nara+Park%2C+Nara%2C+Japan",
        linkLabel: "OPEN IN MAPS",
      },
      {
        time: "10:30",
      ...
      { time: "14:30", title: "Collect the suitcases", note: "Return to Kintetsu-Nara Station and retrieve every bag before boarding" },
      { time: "15:00", title: "Train from Nara to Osaka", note: "Kintetsu-Nara → Osaka-Namba · about 40 minutes by rapid express" },
      {
        time: "16:00",
        title: "Check in at the Osaka hotel",
        note: "8-chōme-9-15 Fukushima 和 101, Osaka, Osaka 553-0003, Japan · drop the luggage and take a short break",
        url: "https://www.google.com/maps/search/?api=1&query=8-chome-9-15+Fukushima+101%2C+Fukushima+Ward%2C+Osaka%2C+553-0003%2C+Japan",
        linkLabel: "OPEN IN MAPS",
      },
      { time: "18:00", title: "Namba & Dōtonbori", note: "Dinner, neon, and a relaxed first Osaka night" },
    ],
    stay: "Osaka · Night 1",
    transfer: "Kyoto → Nara → Osaka",
  },
  {
    id: 6,
    date: "14",
...
const trainLegs = [
  ...
  { from: "Kyoto", to: "Nara → Osaka", date: "DEC 13", time: "~1H 35M rail", note: "Kintetsu · sightseeing stop" },
...
const initialBookings = [
  ...
  { id: "osaka", label: "Osaka hotel", detail: "Dec 13–15 · 2 nights · 8-chōme-9-15 Fukushima 和 101, Osaka, Osaka 553-0003", done: false },
